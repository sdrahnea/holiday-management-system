...
```
XXX:holiday-management-system xxx java -jar target/holiday-management-system-X.Y.Z-SNAPSHOT.jar
```
### Deployment & run on LINUX environment
...
```
nohub java -jar holiday-management-system-1.0.0.jar --spring.config.location=/app/config/application.properties &
```
...
```
java -jar D:\projects\app\holiday-management-system-1.0.0.jar --spring.config.location=D:/projects/app/config/application.properties
```
